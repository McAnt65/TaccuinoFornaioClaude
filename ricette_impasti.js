...
numero: 19,
        ...
        note: "✨ <strong>Il Segreto di Puglia:</strong> Lessate la patata e schiacciatela perfettamente con lo schiacciapatate quando è ancora calda. Lasciatela intiepidire prima di inserirla nel cestello insieme alle farine e all'acqua.<br><br><strong>📏 Riferimento Teglie:</strong> La dose base da 500 g di farine è ideale per una teglia rettangolare da circa 30×40 cm oppure per una teglia tonda da 32-34 cm di diametro, ottenendo una focaccia soffice e di altezza tradizionale. Se scegli il formato da 750 g, utilizza una teglia da circa 35×45 cm. Con il formato da 1000 g puoi riempire comodamente una leccarda domestica standard da forno (circa 40×35 cm) ottenendo una focaccia più alta oppure due teglie tonde da 30 cm.<br><br><strong>🔥 Cottura Tradizionale:</strong> Al termine del programma 10, ungi abbondantemente la teglia, stendi l'impasto senza sgonfiarlo, lascia riposare 20-30 minuti, condisci con pomodorini, olive e origano e cuoci in forno statico già caldo a 250°C per circa 18-22 minuti, fino a ottenere una superficie ben dorata e un fondo croccante."    }
);
